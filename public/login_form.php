...
<div id="login_content" class="col-md-11 login">
  	...
  	<div class="col-md-4 col-md-offset-4">
	      <div class="panel panel-default" style="background-color: rgba(0,0,0,.25);  color: #fff">
			  <!-- Default panel contents -->
			  <div class="panel-heading" style="background-color: rgba(0,0,0,.25); color:#fff;">
			  ...
			  <div class="panel-body">
				...
				<a href="forget-password.php"><p style="color: #fff" class="pull-right">Forgot Password?</p></a>
			  </div>
			</div>
	</div>
</div>
